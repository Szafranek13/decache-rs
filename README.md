...
## Current pre-Alpha version (0.1.2) for Linux:
...
Aka what has been added since the last release.

![](screenshot-dev.png)

More polished ui. You can turn off some types of scanning in the new options panel.
